...
public class DepthChartGUI extends JDialog {
    ...
    JLabel K;
    JTable qbTextArea;
    JTextArea hbTextArea;
    JTextArea fbTextArea;
    JTextArea teTextArea;
    JTextArea wrTextArea;
    JTextArea tTextArea;
    JTextArea gTextArea;
    JTextArea cTextArea;
    JTextArea deTextArea;
    JTextArea dtTextArea;
    JTextArea olbTextArea;
    JTextArea mlbTextArea;
    JTextArea cbTextArea;
    JTextArea fsTextArea;
    JTextArea ssTextArea;
    JTextArea pTextArea;
    JTextArea kTextArea;
    JButton addButton;
