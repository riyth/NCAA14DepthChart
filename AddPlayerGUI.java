...
public class AddPlayerGUI extends JFrame {
    ...
    public AddPlayerGUI() {
        ...
        errorArea.setText("To add a player, input all information and select add.\nTo remove a player, input their name and select remove.");
